...
void loop() {
    ...
    switch ( key ) {
        ...
        case 'f': // 前進
            ...
            motor(1, BACKWARD, 200);  //LU
            motor(2, BACKWARD, 200);  //LD
            motor(3, FORWARD, 200);   //RU
            motor(4, FORWARD, 200);   //RD
        ...
        case 'b': // 後退
            ...
            motor(1, FORWARD, 200);  //LU
            motor(2, FORWARD, 200);  //LD
            motor(3, BACKWARD, 200);  //RU
            motor(4, BACKWARD, 200);  //RD
        ...
        case '1': // 左上平移
            ...
            motor(1, RELEASE, 0);     //LU
            motor(2, BACKWARD, 200);  //LD
            motor(3, FORWARD, 200);   //RU
            motor(4, RELEASE, 0);     //RD
        ...
        case '2': // 左下平移    
            ...
            motor(1, FORWARD, 200);  //LU
            motor(2, RELEASE, 0);    //LD
            motor(3, RELEASE, 0);    //RU
            motor(4, BACKWARD, 200);  //RD
